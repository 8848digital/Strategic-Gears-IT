...
from it_module.it.doctype.it_asset.it_asset import get_asset_account
from erpnext.controllers.accounts_controller import AccountsController


class ITAssetRepair(AccountsController):
	def validate(self):
	...
	def update_status(self):
		if self.repair_status == "Pending":
			frappe.db.set_value("IT Asset", self.asset, "status", "Out of Order")
		else:
	...
	def after_delete(self):
		frappe.get_doc("IT Asset", self.asset).set_status()
