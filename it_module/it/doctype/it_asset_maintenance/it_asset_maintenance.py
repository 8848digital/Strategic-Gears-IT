...
class ITAssetMaintenance(Document):
	def validate(self):
	...
	def sync_maintenance_tasks(self):
		...
		if asset_maintenance_logs:
			for asset_maintenance_log in asset_maintenance_logs:
				maintenance_log = frappe.get_doc("IT Asset Maintenance Log", asset_maintenance_log.name)
...
def update_maintenance_log(asset_maintenance, item_code, item_name, task):
	...
	if not asset_maintenance_log:
		asset_maintenance_log = frappe.get_doc(
			{
				"doctype": "IT Asset Maintenance Log",
				"asset_maintenance": asset_maintenance,
		...
		maintenance_log = frappe.get_doc("IT Asset Maintenance Log", asset_maintenance_log)
...
def get_maintenance_log(asset_name):
	return frappe.db.sql(
        ...
        from `tabIT Asset Maintenance Log`
